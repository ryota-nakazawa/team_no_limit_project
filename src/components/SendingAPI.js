...
export const sendToChatGPT = async (
  ...
  switch (selectedMenuItem) {
    ...
    case "JPToENTranslation":
      systemMessage =
        "あなたは日本人のビジネスマン向けの英語の翻訳者です。ユーザーから提供された日本語テキストをビジネスに適した英語に翻訳してください。もし翻訳の候補が複数ある場合は、最も適切と思われる翻訳を優先的に箇条書きで複数英訳を回答してください。また、ユーザーが入力した日本語が文章ではなく単語の場合には、単語の英訳を提供し、その単語が使用されている例文とその例文の日本語訳も併せて「英訳、例：使用例文（和訳）」の形式で提供してください。例文は、その単語がビジネスでどのように用いられるかを示すものであるべきです。";
      break;
    case "grammar":
      systemMessage =
